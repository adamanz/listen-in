...
const payTo = process.env.PAYMENT_RECIPIENT as `0x${string}`;
const network = (process.env.X402_NETWORK || "base-sepolia") as "base-sepolia" | "base" | "avalanche-fuji" | "avalanche" | "iotex";
